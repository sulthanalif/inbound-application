...
<div class="row">
    ...
    <div class="col-xxl-3 col-md-3">
        <div class="card info-card sales-card">
            ...
            <div class="card-body">
                <h5 class="card-title">Pending Pickup <span>Outbound</span></h5>
    ...
    <div class="col-xxl-3 col-md-3">
        <div class="card info-card sales-card">
            ...
            <div class="card-body">
                <h5 class="card-title">Pending Delivery <span>Outbound</span></h5>
...
<div class="row">
    <div class="col-xxl-4 col-md-4">
        <div class="card info-card sales-card">
            ...
            <div class="card-body">
                <h5 class="card-title">pending goods to arrive <span>Inbound</span></h5>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                        <h6>{{ $stats['inbounds']['goodsArrived'] }}</h6>
                        {{-- <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">increase</span> --}}
