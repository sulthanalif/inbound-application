                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="nip" type="text"
                                                ...
                                                value="{{ Auth::user()->nip }}"
                                                placeholder="{{ Auth::user()->nip ? null : 'Enter your NIP....' }}">
                                            @error('nip')
                                                <small class="text-danger text-xs mt-2">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="company" type="text"
                                                ...
                                                placeholder="{{ Auth::user()->company ? null : 'Enter your company....' }}">
                                            @error('company')
                                                <small class="text-danger text-xs mt-2">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="position" type="text"
                                                ...
                                                placeholder="{{ Auth::user()->position ? null : 'Enter your position....' }}">
                                            @error('position')
                                                <small class="text-danger text-xs mt-2">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <textarea name="address" class="form-control @error('address') is-invalid @enderror" id="Address" rows="3"
                                                placeholder="{{ Auth::user()->address ? null : 'Enter your address....' }}">{{ Auth::user()->address }}</textarea>
                                            @error('address')
                                                <small class="text-danger text-xs mt-2">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="phone" type="number"
                                                ...
                                                placeholder="{{ Auth::user()->phone ? null : 'Enter your phone....' }}">
                                            @error('phone')
                                                <small class="text-danger text-xs mt-2">
                                                    {{ $message }}
                                                </small>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email"
                                                ...
                                                placeholder="{{ Auth::user()->email ? null : 'Enter your email....' }}">
                                            @error('email')
                                                <small class="text-danger text-xs mt-2">
                                                    {{ $message }}
                                                </small>
